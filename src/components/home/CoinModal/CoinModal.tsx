...
const CoinModal = ({ toggleExchange, data, toggleDisplayModal, displayModal }: any) => {
    ...
    return (
        <div className={`${styles.modalOverlay} ${!displayModal ? styles.hiddenModal : ''}`}>
            <div onClick={() => toggleDisplayModal(false)} className="absolute z-[-1] w-full h-full left-0 top-0"></div>
